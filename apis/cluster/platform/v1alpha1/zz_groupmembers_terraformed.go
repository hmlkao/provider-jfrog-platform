...
// GetInitParameters of this GroupMembers
func (tr *GroupMembers) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this GroupMembers
func (tr *GroupMembers) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
