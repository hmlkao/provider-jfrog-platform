...
func Configure(p *config.Provider) {
	p.AddResourceConfigurator("platform_global_role", func(r *config.Resource) {
		r.ShortGroup = "platform" // Otherwise 'global' is used
		r.Kind = "GlobalRole"     // Otherwise 'Role' is used
